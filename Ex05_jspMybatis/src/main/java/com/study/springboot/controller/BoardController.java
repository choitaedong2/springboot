...
public class BoardController {
	...
	@RequestMapping("/") // root 호출
	public String root() {
		return "redirect:list"; // localhost:8000/list를 호출
	}
	 ...
	 * 요청 처리 후 응답페이지로 포워딩 또는 url재요청시 응답데이터를 담는 방법
	  1. Model 객체
	  	 ...
	  	 requestScope임.
	  	 *** 단, setAttribute가 아닌 addAttribute메도스를 이용
