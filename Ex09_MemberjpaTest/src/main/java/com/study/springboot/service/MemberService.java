...
public class MemberService {
	...
	public void insert(Object object) {
		...
		member = new Member("조조은", "test3@test.com");
		memberRepository.save(member);
		...
		member = new Member("양조은", "test7@test.com");
		memberRepository.save(member);
		
		member = new Member("김조은", "test8@test.com");
		memberRepository.save(member);
		
		member = new Member("오조은", "test9@test.com");
		memberRepository.save(member);
	...
	public List<Member> selectNameLike(String name2) {
		return memberRepository.findByNameLike(name2);
	}

	public List<Member> selectByNameLikeNameDesc(String name2) {
//		return memberRepository.selectByNameLikeOrderByName(name2); -> 오름차순 정렬
//		return memberRepository.selectByNameLikeOrderByNameDescOrderByEmail(name2);
		return memberRepository.selectByNameLikeOrderByNameDesc(name2);
	}
